...
@Secure(id = "URL_LIST_PEDIDO", permissionType = UrlPermission.class)
public class PesquisaPedido extends CrudModelPage<PesquisaPedidoModel, Pedido> {

	public Page createNewPage() {
		return new CadastroPedido(new PageParameters());
	}
	...
	public List<Pedido> search(DAOFactory daoFactory) {
		...
		List<Pedido> pedidos = dao.findByPeriodoPesquisa(inicio, fim, null, null);
		return pedidos;
	}

	@Override
	protected Page createFormPage(Pedido arg0, FormType arg1) {
		return null;
	}
